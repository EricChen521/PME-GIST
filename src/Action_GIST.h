...
class Action_GIST : public Action {
  ...
  private:
    ...
    DataSet_3D* PME_; ///< the nonbond interaction( charge-charge + vdw) cal
...
#   endif
    ...
    std::vector<Darray> E_pme_; ///Total nonbond interaction energy(VDW + electrostatic) calculated by PME
